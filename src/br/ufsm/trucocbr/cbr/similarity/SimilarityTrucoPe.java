...
public class SimilarityTrucoPe {
    ...
    public NNConfig getSimilarityConfig()
    {
        ...
        attribute = new Attribute("ganhadorTrucoMao", TrucoDescription.class);
        function = new Equal();
        config.addMapping(attribute, function);
        config.setWeight(attribute, new Double(4.0D));

        attribute = new Attribute("ganhadorPediuTruco", TrucoDescription.class);
        function = new Equal();
        config.addMapping(attribute, function);
        config.setWeight(attribute, new Double(5.0D));

        /*attribute = new Attribute("rodadaPediuTruco", TrucoDescription.class);
        function = new Equal();
        config.addMapping(attribute, function);
        config.setWeight(attribute, new Double(5.0D));*/
